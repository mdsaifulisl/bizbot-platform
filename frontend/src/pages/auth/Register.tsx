...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      // রেজিস্ট্রেশন সফল হলে লগইন পেজে রিডাইরেক্ট করবে
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Enter your details to register as a customer</p>
        {alertMessage && (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300" htmlFor="name">Full Name</label>
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-10 pr-3 py-2 bg-light-bg border border-light-border dark:bg-dark-bg dark:border-dark-border rounded-md text-zinc-900 dark:text-zinc-50 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:border-emerald-500 transition-colors"
              value={formData.name}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              required
              className="w-full pl-10 pr-10 py-2 bg-light-bg border border-light-border dark:bg-dark-bg dark:border-dark-border rounded-md text-zinc-900 dark:text-zinc-50 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:border-emerald-500 transition-colors"
        ...
        <div className="flex items-start gap-2 pt-1">
          <input
            id="agreeTerms"
            type="checkbox"
            className="mt-1 accent-emerald-500 h-4 w-4 rounded border-light-border dark:border-dark-border"
            checked={formData.agreeTerms}
            onChange={(e) => setFormData({ ...formData, agreeTerms: e.target.checked })}
          />
          <label htmlFor="agreeTerms" className="text-xs text-zinc-500 dark:text-zinc-400 leading-normal select-none">
            I agree to the{" "}
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full py-2 px-4 bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-700 text-zinc-950 font-semibold rounded-md transition-colors cursor-pointer shadow-sm mt-2"
      >
    ...
    <div className="relative flex items-center justify-center my-4">
      ...
      <span className="relative px-3 bg-light-card dark:bg-dark-card text-xs text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Or register with</span>
    </div>
